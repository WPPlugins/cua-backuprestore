          ...
          $table = "<table id='cuabr_recents'
           ...
           foreach ( $backupset_list as $backupset ) {
                   ...
                   if ( $file_size_in_bytes >= $max_upload_size ) {
                        ...
                        $size_flag = "<img src=\"" . plugins_url('cua-backup-restore/img/green.png', 
                                                                 'cuabr-backup-restore') ."\"> ";
                        $green_flag = true;
                   }                  
                   if ( $file_size_in_bytes >= $max_total_upload_size ) {
                        $size_flag = "<img src=\"" . plugins_url('cua-backup-restore/img/red.png', 
                                                                 'cuabr-backup-restore') ."\"> ";
                        $red_flag = true;
                   }                  
           ...
           if ( $green_flag ) {
              $table = "<img src=\"" . plugins_url('cua-backup-restore/img/green.png', 
                                                   'cuabr-backup-restore') ."\"> &nbsp;
                        indicates file will need to be splitted if downloaded 
                        and then later uploaded back.<br>" . $table;
           } 
           if ( $red_flag ) {
              $table = "<img src=\"" . plugins_url('cua-backup-restore/img/red.png', 
                                                   'cuabr-backup-restore') ."\"> &nbsp;
