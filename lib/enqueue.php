...
function cuabr_ajax_related() {
   ...
   wp_register_script('cuabr_ajax', 
                    plugins_url('cua-backup-restore/js/cuabr-jscripts.js'), 
                    array('jquery'), 
                    '1.0.0', 
                    false );
   ...
   wp_register_script('cuabr_dialog', 
                    plugins_url('cua-backup-restore/js/cuabr-sweetalert.js'), 
                    array('jquery'), 
                    '1.0.0', 
                    false );
...
function cuabr_dialog_related() {
        wp_enqueue_style( 'cuabr_sweetalert_css', plugins_url('cua-backup-restore/css/cuabr-sweetalert.css') );
}
